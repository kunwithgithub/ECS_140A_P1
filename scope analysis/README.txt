...
1. Java source files for scope analysis, including a partially completed parser module (Parser.java).

2. Byte code files for scope analysis, including a completed parser module.
